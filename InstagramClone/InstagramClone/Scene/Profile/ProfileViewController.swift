...
class ProfileViewController: UIViewController {
    ...
    private let uploadDataView = ProfileDataView(title: "게시글", count: 100)
    private let followerDataView = ProfileDataView(title: "팔로워", count: 123)
    private let followingDataView = ProfileDataView(title: "팔로잉", count: 130)
...
private extension ProfileViewController {
    func setupNavigationController(){
        ...
        let button = UIBarButtonItem(image: UIImage(systemName: "ellipsis"), style: .plain, target: self, action: #selector(didTapRightBarButtonItem))
        navigationItem.rightBarButtonItem = button
    }
    
    @objc func didTapRightBarButtonItem() {
        // UIAlertController - actionsheet이용
    ...
    func setupLayout() {
        ...
        let profileDataStackView = UIStackView(arrangedSubviews: [uploadDataView, followerDataView, followingDataView])
        profileDataStackView.spacing = 4.0
